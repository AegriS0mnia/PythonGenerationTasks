...
extension_count = Counter([file.split('.')[-1] for file in files])

for file_extension in sorted(extension_count):
    print(f'{file_extension}: {extension_count[file_extension]}')
