...
stepik = len(re.findall('^(stepik)', article, flags=re.IGNORECASE | re.MULTILINE))
etc_exclamation_mark = len(re.findall('(\.\.\.)|(!)$', article, flags=re.IGNORECASE | re.MULTILINE))

print(stepik, etc_exclamation_mark, sep='\n')
